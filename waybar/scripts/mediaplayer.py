"""
Kudos to https://github.com/Alexays
code copied from https://github.com/Alexays/Waybar/blob/master/resources/custom_modules/mediaplayer.py
"""
...
def main():
    ...
    # Initialize logging#!/usr/bin/env python3
gi.require_version("Playerctl", "2.0")
